...
function socketConnect(){
    ...
    let socket = new SockJS("https://quickmobility-backend.herokuapp.com"+"/ofrecerViaje/"+userLocalestorage.username);
        ...
        return (
            <Grid container>
                ...
                <Grid item xs={12} sm={6} id="zonamapa">
                    <iframe id="mapazona" title="zonas" src="https://www.google.com/maps/d/embed?mid=1OvtjtTy8wBHAMww-SdVn06YgIlup4Ciu" width="640" height="480"></iframe>
                </Grid>
