...
class DriverTripModal extends Component {
    ...
    async componentDidMount() {
        ...
        await axios.get(`https://quickmobility-backend.herokuapp.com/quickmobility/travel/driver/` + userLocalestorage.username,
            {
                headers: {
    ...
    render() {
        ...
        const viaje = {
            ...
            viajeCurso: { inicio: "Usaquen", destino: "Prado", estado: "en curso" },
            conductor: { name: "Will Smith", email: "wsmith@gmail", rating: 4 },
